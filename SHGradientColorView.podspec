#
#  Be sure to run `pod spec lint SHGradientColorView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ShengHuaWu/SHGradientColorView.git", :tag => "#{s.version}" }
